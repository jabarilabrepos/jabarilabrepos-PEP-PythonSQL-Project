...
def load_and_clean_users(file_path):
    ...
    with open(file_path, 'r', newline='') as file:
        ...
        for row in reader:
            ...
            # users.csv contains exactly 2 fields:
            # firstName, lastName
            if len(row) != 2:
                continue
            ...
            # userId is automatically generated by SQLite
            cursor.execute(
...
def load_and_clean_call_logs(file_path):
    ...
    with open(file_path, 'r', newline='') as file:
        ...
        for row in reader:
            ...
            # callLogs.csv contains exactly 5 fields:
            ...
            # callId is automatically generated by SQLite
            cursor.execute(
